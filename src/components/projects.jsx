    ...
    <section id="projects">
      ...
      <div className="project-div">
        ...
        <div className="project-description">
          ...
          <p>Project is deployed <a href="https://allofthefeels.herokuapp.com/">here</a>. Github for All The Feels can be viewed <a href="https://github.com/Amanda2900/allTheFeels">here</a>.</p>
        </div>
      </div>
      <div className="project-div">
        <div className="project-img">
